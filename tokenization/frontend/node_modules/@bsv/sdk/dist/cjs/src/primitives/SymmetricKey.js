...
class SymmetricKey extends BigNumber_js_1.default {
    ...
    encrypt(msg, enc) {
        ...
        const { result, authenticationTag } = (0, AESGCM_js_1.AESGCM)(msg, [], iv, keyBytes);
        ...
        return (0, utils_js_1.encode)(combined, enc);
    }
    /**
    ...
    decrypt(msg, enc) {
        ...
        const result = (0, AESGCM_js_1.AESGCMDecrypt)(ciphertext, [], iv, messageTag, this.toArray('be', 32));
        if (result === null) {
